...
export function StatCard({
  ...
  if (variant === "hero") {
    return (
      <div className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-4 shadow-lg backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:bg-white/15 hover:shadow-xl">
